...
class Pembelian extends CI_Controller
{
    ...
    function detail($id)
    {
        ...
        <?php if (get_project_manager($data->project_id) === $this->session->userdata('nama_user')) { ?>
            <a data-toggle="modal" onclick="approveActPm(<?= $data->id_pembelian ?>)" href="#modal_status"
                class="btn <?= cek_status_pembelian($data->no_pembelian, 1) === 1 ? 'btn-secondary disabled' : 'btn-success' ?>">
                SETUJUI
            </a>
            <a data-toggle="modal" onclick="rejectActPm(<?= $data->id_pembelian ?>)" href="#modal_status"
                class="btn <?= cek_status_pembelian($data->no_pembelian, 1) === 1 ? 'btn-secondary disabled' : 'btn-danger' ?>">
                TOLAK
            </a>
        <?php } ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group required">
                        ...
                        <input type="text" class="form-control <?= form_error('fno_pembelian') ? 'is-invalid' : '' ?>"
                            id="fno_pembelian" name="fno_pembelian" value="<?= $data->no_pembelian ?>" readonly>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group required">
