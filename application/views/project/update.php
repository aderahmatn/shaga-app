                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <form role="form" method="POST" action="" autocomplete="off">
                            ...
                            <input type="hidden" name="fid" value="<?= encrypt_url($project->project_id) ?>"
                                style="display: none">
                            ...
                            <div class="form-group required">
                                ...
                                <select
                                    ...
                                    <?php foreach ($user as $key): ?>
                                        <option value="<?= $key->id_user ?>" <?= $project->project_manager == $key->id_user ? 'selected' : '' ?>>
                            ...
                            <div class="form-group required">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="<?= rupiah_no_rp($project->project_value) ?>">
                                    <div class=" invalid-feedback">
                            ...
                            <div class="form-group required">
                                ...
                                <textarea name="fproject_location"
                                    ...
                                    placeholder="Alamat project"><?= $project->project_location ?></textarea>
                                <div class="invalid-feedback">
