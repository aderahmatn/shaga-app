            ...
            <div class="col-md-3 mb-3">
                <div class="list-group">
                    <a href="<?= base_url('pengaturan/ganti_pass') ?>"
                        class="list-group-item list-group-item-action <?= $this->uri->segment(1) == 'pengaturan' ? 'active' : '' ?>">
                        Ganti Password
                    </a>
                    <a href="<?= base_url('pengaturan/whatsapp') ?>"
                        class="list-group-item list-group-item-action <?= $this->uri->segment(1) == 'whatsapp' ? 'active' : '' ?> disabled">Pengaturan
                        Whatsapp</a>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="callout callout-success">
                            ...
                            <p>Password dapat berupa huruf, angka dan simbol. Minimal 8 digit.
                            </p>
                        </div>
