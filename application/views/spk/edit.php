                ...
                <div class="card ">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between ">
                            <h5 class="text-warning ">EDIT DATA SPK [<?= $data->no_spk ?>]</h5>
                            <a href="<?= base_url('spk') ?>" class="btn btn-sm btn-default float-right">Batal</a>
                        </div>
                        <hr>
                        <form role="form" method="POST" action="" autocomplete="off">
                            ...
                            <div class="form-group required">
                                ...
                                <input type="text" class="form-control <?= form_error('fnama_site') ? 'is-invalid' : '' ?>" id="fnama_site" name="fnama_site" placeholder="Nama site" value="<?= $data->nama_site ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group required">
                                ...
                                <select class="form-control <?php echo form_error('fjenis_site') ? 'is-invalid' : '' ?>" id="fjenis_site" name="fjenis_site">
                                    ...
                                    <option value="pelanggan" <?= $data->jenis_site == 'pelanggan' ? 'selected' : '' ?>>PELANGGAN </option>
                                    <option value="pop" <?= $data->jenis_site == 'pop' ? 'selected' : '' ?>>POP </option>
                                </select>
                                <div class="invalid-feedback">
