            ...
            <div class="col-md-3">
                <div class="card ">
                    <div class="card-header">
                        <h5 class="text-primary card-title">BUAT SPK PELANGGAN</h5>
                    </div>
                    <!-- card-body -->
                    <div class="card-body">
                        <form role="form" method="POST" action="" autocomplete="off">
                            ...
                            <input type="hidden" name="fid_pelanggan" id="fid_pelanggan" style="display: none">
                            ...
                            <div class="form-group required">
                                ...
                                <div class="input-group ">
                                    <input type="text" class=" form-control <?php echo form_error('fnama_site') ? 'is-invalid' : '' ?>" id="fnama_site" name="fnama_site" onfocus="onFocusPelanggan()" placeholder="Pilih pelanggan" value="<?= $this->input->post('fnama_site'); ?>">
                                    <span class="input-group-append">
                            ...
                            <div class="form-group required">
                                <label class="control-label" for="fno_layanan">No. Layanan</label>
                                <input type="text" class="form-control <?= form_error('fno_layanan') ? 'is-invalid' : '' ?>" id="fno_layanan" name="fno_layanan" placeholder="Nomor Layanan" value="<?= $this->input->post('fno_layanan'); ?>">
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group required">
                                ...
                                <textarea name="falamat_site" class="form-control <?= form_error('falamat_site') ? 'is-invalid' : '' ?> " placeholder="Alamat pelanggan" id="falamat_site"><?= $this->input->post('falamat_site'); ?></textarea>
                                <div class="invalid-feedback">
